...
* Tagging of German speech, thought and writing representation (STWR) via custom fine-tuned BERT embeddings, similar to [Brunner, Tu, Weimer, Jannidis (2020)](#ref-brunner_bert_2021); model [`aehrm/modernbert-redewiedergabe`](https://huggingface.co/aehrm/modernbert-redewiedergabe).
