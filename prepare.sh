...
test -f "./stss-se-scene-segmenter/model.tar.gz" || poetry run gdown 1yayKtOT2pGD7YQpL-r9p3D-ErMt6rVeR -O ./stss-se-scene-segmenter/model.tar.gz
mkdir ./stss-se-scene-segmenter/extracted_model
tar xf ./stss-se-scene-segmenter/model.tar.gz -C ./stss-se-scene-segmenter/extracted_model
