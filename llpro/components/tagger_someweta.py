...
@Language.factory("tagger_someweta", assigns=['token.pos', 'token.tag', 'token.morph'],
                  default_config={'model': LLPRO_RESOURCES_ROOT + '/german_newspaper_2020-05-28.model', 'pbar_opts': None})
...
class SoMeWeTaTagger(Module):
    ...
    def __init__(self, name, model=LLPRO_RESOURCES_ROOT + '/german_newspaper_2020-05-28.model', pbar_opts=None):
